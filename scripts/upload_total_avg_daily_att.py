...
file_name = "total-avg-daily-att.csv"
...
with open(file_name, 'r') as csv_file:
    ...
    cleaned_rows.append(["id", "name", "daysEnrolled", "daysNotEnrolled", "daysPresent", "daysExcused", "daysNotExcused", "upToWeek", "sy", "attPercentage", "excusedPercentage"])
...
print("Processing completed and saved to 'total-avg-daily-att.csv'")
